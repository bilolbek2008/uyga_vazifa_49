...
class _RejalarState extends State<Rejalar> {
              ...
              onPressed: () {
                setState(() {
                  rejalar[index] = Reja(
                    ...
                    title: titleController.text,
                    date: dateController.text,
                    completed: rejalar[index].completed,
                  );
                });
                Navigator.of(context).pop();
              },
  ...
  void _toggleCompletion(int index) {
    setState(() {
      rejalar[index].completed = !rejalar[index].completed;
    });
  }
              ...
              Container(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    rejalar[index].title,
                    style: TextStyle(
                      decoration: rejalar[index].completed
                          ? TextDecoration.lineThrough
                          : TextDecoration.none,
                    ),
                  ),
                  subtitle: Text('${rejalar[index].date}'),
                  isThreeLine: true,
                  trailing: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
